...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes a number, which becomes first arg in the block
    # The array that inject is called on then becomes the second item
  end
  ...
  #   # code to read 'file'
  #
  # I'm not sure why we would set to a variable ... 
