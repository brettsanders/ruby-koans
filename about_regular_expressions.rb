...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # It could fail in a situation where there is something AFTER
    # the star that doesn't match
    # example "abbcccddddeeeee"[/z*z]  -->  nil
  end
  ...
  #
  # Why?
  # Because they take in more characters if they are present
  ...
  # Character class is more general
  # Alternation gives specific options
  # The character class may be faster
