...
class AboutSymbols < EdgeCase::Koan
  ...
  # 
  # Because when we do symbols_as_strings.include?(:symbol)
  # :symbol will be created and so the statement will have to be true
  ...
  # Because symbols stay in memory -- although they're faster
  # They'll become a memory hog is too many are created
  # They're released only when the program ends
end
